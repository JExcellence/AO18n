 ...
 * <p>If the player is detected as a Bedrock player and Bedrock support is enabled,
    ...
    public void sendMessage(@NotNull Player player, @NotNull Component component) {
        ...
        // Paper/Purpur/Folia — Player is a native Adventure Audience. Sending
        // Components directly preserves ClickEvent/HoverEvent; the legacy
        // BukkitAudiences shim strips them on modern Paper. Prefer native.
        if (versionDetector.hasNativeAdventure()) {
