...
public class R18nSection {
    ...
    /**
     * Returns the forced locale override. When non-null, every player
     * receives translations in this locale regardless of their client
     * language setting. Defaults to {@code null} (honour client locale).
     *
     * @return the forced locale, or null if not set
     */
    ...
    /**
     * Sets the forced locale override.
     *
     * @param forceLocale the locale to force, or null to honour client locales
     */
